...
echo "removing Symlinks" >> "$destination"/mdal_log.txt 2>&1
...
echo "Processing proj data" >> "$destination"/mdal_log.txt 2>&1
echo "copy $destination/share/proj to $shared_assets" >> "$destination"/mdal_log.txt 2>&1
